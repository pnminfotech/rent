        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4 class="d-none">Building Lightbill</h4>
...
$sql = "SELECT * from  flat_lightbill_payment"; 
...
?>
     ...
     <tr>
                     	...
                     	<td data-title="Flat"><?php echo $row["flat_no"];  ?></td>
                        ...
                        <td data-title="Reading"><?php echo $row["old_reading"];  ?></td>
                        <td data-title="Reading"><?php echo $row["current_reading"];  ?></td>
