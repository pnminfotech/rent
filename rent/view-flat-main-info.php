...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"UPDATE flat_details SET property = '$property',flat_name='$flat_name',phone='$phone',room_type='$room_type',sq_ft='$sq_ft',availonrent='$availonrent',meter_no='$meter_no',floor='$floor',owner_name='$owner_name',address='$address',age='$age'
        WHERE id = '".$_POST["id"]."'");
   if($query==1){
     mysqli_query($conn,"UPDATE rent_update_details SET floor='$floor',flat_name='$flat_name',room_type='$room_type',property = '$property' where flat_no='$flat_no' and wing='$wing' and building_name='$building_name'");
     if(mysqli_affected_rows($conn) >= 0){
        echo '<script language="javascript">;

         location.href="view-flat-details.php?b_id='.$b_id.'&building_name='.$building_name.'&wing='.$wing.'";
        </script>';
    } else {
        echo " NOT Updated<br />";
  ...
  <a href="home.php" class="logo"><span>Rent</span></a>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
         ...
         <span class="main-title">Flat Details</span>  
         <ul class="breadcrumb">
          ...
          <li>Building</li>
           ...
           <li>Flats</li>
            ...
            <div class="row">
            	 ...
            	 <div class="col-lg-12"><div class="col-lg-6"><h4 class="po-ab">Flat Details</h4></div>
            		 <?php 
            		 $building_name=$_REQUEST['building_name'];
            		 $id=$_REQUEST['b_id'];
            		 $wing=$_REQUEST['wing'];
            		 ?>
            		        <div class="col-lg-6 pr-0"><a href="view-flat-details.php?building_name=<?php echo $building_name;?>&wing=<?php echo $wing;?>&b_id=<?php echo $id;?>"><button type="button" class="float-r float-right back-btn btn btn-secondary btn-sm"><i class="fa fa-mail-reply-all"></i> Back</button></a>
            		 </div>
            		 </div>
  		<div class="adv-table" id="no-more-tables">
				...
				<tr role="row">
					...
					<th role="columnheader">Flat Name</th>
...
?>
			      <tbody>
                         ...
                         while($row = $result->fetch_assoc()) {
                             ?>
                        <tr>
       						   <td data-title="sr No"><?php echo $row["flat_no"];?></td>   
       						    <td data-title="Flat Name"><?php echo $row["flat_name"];?></td>   
                         ...
                         while($row = $result->fetch_assoc()) {
                             ?>
              					    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post" style="padding: 10px;">
    											...
    											<label class="col-form-label col-md-3 col-sm-3 label-align white-col" for="first-name">Flat No <span class="required">*</span>
    											</label>
											...
											<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 label-align white-col" for="first-name">Building Name <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
													...
													<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 label-align white-col" for="first-name">Wing <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
											...
											<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 label-align white-col" for="first-name">Flat Name <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
    												<input type="text"  id="first-name" name="flat_name" value="<?php echo $row["flat_name"];  ?>" required="required" class="form-control " Placeholder="Flat Name">
    											</div>
											</div>
											<div class="item form-group">
    											<label class="col-form-label  col-md-3 col-sm-3  label-align white-col" for="first-name">Room Type <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
									    	...
									    	<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 label-align white-col" for="first-name">Property  <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
													<select name="property" id="first-name" class="form-control" required="required">
                                                     	<option value="" disabled selected>Select Property From Here</option>
                									                    ...
                									                    <option value="Semi_Commercial" <?php if ($row["property"] == "Semi_Commercial") { echo 'selected'; } ?>>Semi-Commercial</option>
                									
                                     		        </select>    											</div>
											</div>
											<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Area Sq.ft <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
											...
											<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Floor Number <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
    											   <select name="floor" id="first-name" class="form-control" required="required">
                                                     	<option value="" disabled selected>Select From Here</option>
                                                        <option value="0" <?php if ($row["floor"] == "0") { echo 'selected'; } ?>>0</option>                                                              	                                    
                									    ...
                									    <option value="9" <?php if ($row["floor"] == "9") { echo 'selected'; } ?>>9</option>  
                									    <option value="10" <?php if ($row["floor"] == "10") { echo 'selected'; } ?>>10</option>  
                                     		        </select>
    											</div>
											</div>
											<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Meter Number <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
											...
											<div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Owner Name <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
										    ...
										    <div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Owner Phone No: <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
                                            ...
                                            <div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Owner Age: <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
    												<input type="text"  name="age" value="<?php echo $row["age"];  ?>"  class="form-control " Placeholder="Owner Age">
    											</div>
											 </div>
                                    
                                           <div class="item form-group">										
    											<label class="col-form-label col-md-3 col-sm-3 white-col label-align" for="first-name">Owner Address: <span class="required">*</span>
    											</label>
    											<div class="col-md-6 col-sm-6 ">
    												<input type="text"  name="address" value="<?php echo $row["address"];  ?>"  class="form-control " Placeholder="Owner Address">
    											</div>
											 </div>
