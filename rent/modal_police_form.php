...
if(!empty($_POST['id']))
{
$sql = "select a.*,b.owner_name,b.phone as owner_phone,b.age as owner_age,b.address as owner_address from flat_rental a,flat_details b where  a.id = '".$_POST["id"]."' and a.flat_no=b.flat_no and a.building_name=b.building_name and a.wing=b.wing";
             ...
             <tr class="tr_police">
                ...
                <tr class="tr_police">
                    <td rowspan=2"><label>८</label></td>
                     ...
                     <td width="70%" colspan="3">'.$row["ref_person_one"].'<br>Address :'.$row["ref_person_one_addr"].'Age : ' .$row["ref_person_one_age"].'</td>
                </tr>
                 <tr class="tr_police">
                   
                     <td width="70%" colspan="3">'.$row["ref_person_two"].' <br>Address :'.$row["ref_person_two_addr"].'Age : ' .$row["ref_person_two_age"].'</td>
                </tr>
                <tr class="tr_police">
                     <td ><label>९</label></td>
