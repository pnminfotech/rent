         ...
         <div class="showback">            
            ...
            <div class="row mt1">
          		<div class="col-lg-12">
            		 ...
            		 <div class="col-lg-12 pl-0"><div class="col-lg-6 col-md-6 pl-0 col-sm-6 pl-0" ><h4 class="po-ab darksalmon">Tenant Details</h4></div>
            		 <?php 
            		 $building_name=$_REQUEST['building_name'];
            		 $id=$_REQUEST['b_id'];
            		 $wing=$_REQUEST['wing'];
            		 ?>
            		     <div class="col-lg-6 col-lg-6 col-md-6 col-sm-6 pr-0"><a href="view-rent-flat-details.php?building_name=<?php echo $building_name;?>&wing=<?php echo $wing;?>&b_id=<?php echo $id;?>"><button type="button" class="float-right float-r back-btn btn btn-secondary btn-sm"><i class="fa fa-mail-reply-all"></i> Back</button></a>
            		 </div>
            	</div>	
...
?>
              ...
              <div class="row mt1">
          		<div class="col-lg-12">
           			 <div class="content-panel">
            		 <div class="col-lg-12 pl-0 d-none"><div class="col-lg-6 pl-0"><h4 class="">Rent Details</h4></div>
            		 <?php 
            		   $building_name=$_REQUEST['building_name'];
            		   $id=$_REQUEST['b_id'];
            		   $wing=$_REQUEST['wing'];
...
?>
			      <tbody>
                        ...
                        <tr>
                          ...
                          <td data-title="Curr Reading"><?php echo $row["current_meter_reading"];  ?></td>   
