...
.ln_solid {
    ...
    {
#hidden-table-info_filter:before {
    color:#b1f55f !important;
...
#hidden-table-info_wrapper > .dataTables_filter {
    width: 97% !important;
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
       ...
       <?php 
            		 ...
            		 ?>
      <span class="main-title">Building - <b><?php echo $building_name;?></b>, Wing - <b><?php echo $wing;?></b>, Flat No - <b><?php echo $flat_name;?></b></span>  
    <ul class="breadcrumb">
...
<?php }}?>   
            ...
            <div class="row mt1">
          		<div class="col-lg-12">
            		 ...
            		 <div class="col-lg-12 pl-0"><div class="col-lg-6 col-md-6 pl-0 col-sm-6"><h4 class="po-ab orange"> Flat Details</h4></div>
            	
            		 <div class="col-lg-6 col-md-6 col-sm-6  pr-0 "><a href="view-tenant-flat-details.php?building_name=<?php echo $building_name;?>&wing=<?php echo $wing;?>&b_id=<?php echo $id;?>"><button type="button" class="float-right float-r back-btn btn btn-secondary btn-sm"><i class="fa fa-mail-reply-all"></i> Back</button></a>
            		 </div>
            		 </div>
...
?>
			      <tbody>
                         ...
                         while($row = $result->fetch_assoc()) {
                             ?>
                        <tr>
	                          <td data-title="Flat No"><?php echo $row["flat_name"];?></td>   
            ...
            <div class="row mt1">
          		<div class="col-lg-12 ">
           			 <div class="content-panel">
            		 <div class="col-lg-12 pl-0"><div class="col-lg-6 pl-0 d-none"><h4 class="light-green">Tenant Details</h4></div>
            		 <?php 
            		 $building_name=$_REQUEST['building_name'];
            		 $id=$_REQUEST['b_id'];
            		 $wing=$_REQUEST['wing'];
...
?>
			      <tbody>
                        ...
                        <tr>
                          ...
                          <td data-title="Action"><button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></button>
                        <button data-toggle="modal" data-target="#view-modal-police" id="getUser" class="btn btn-sm btn-info">Police <i class="fa fa-print"></i></button>
                        </td> 
