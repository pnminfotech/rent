					...
					<div class="col-lg-6 col-md-6 col-sm-6">
                     ...
                     ?>
						...
						<a href="view-flat-wing.php?building_name=<?php echo $building_name;?>&b_id=<?php echo $id;?>"><button
								type="button" class="float-r back-btn btn btn-secondary btn-sm back-btn1">
								<i class="fa fa-mail-reply-all"></i> Back </button></a>
					</div>
				</div>
...
?>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
									...
									<button type="button" class="high btn btn-sm btn-success new-width btn-building ">
										...
										<span class="material-icons building-icon <?php echo $row["availonrent"];  ?>" ><?php if($room == $Residential){ ?>	night_shelter  <?php } ?> 
