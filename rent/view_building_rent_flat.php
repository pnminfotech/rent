...
$sql1 = "select floor from rent_update_details where  floor is not null and user_name is not null group by floor";
...
$sql = "select * from rent_update_details where floor='$i' and user_name is not null and status = 'Occupied'";
...
?>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
									...
									<br> <span class="font-weight-bold f-16"><?php echo $row["flat_name"]; ?></span><br><span><?php echo $row["building_name"]; ?> - <?php echo $row["room_type"]; ?> </span><br>
