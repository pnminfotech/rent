...
<script src="ajax-js/user-data.js"></script>	
<style>
...
/*
	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		#employeeList>tbody>tr>td:nth-of-type(1):after { content: "User Name"; }
		#employeeList>tbody>tr>td:nth-of-type(2):after { content: "Password"; }
			#employeeList>tbody>tr>td:nth-of-type(3):after { content: "Role"; }
		#employeeList>tbody>tr>td:nth-of-type(4):after { content: "Action"; }
  ...
  <a href="home.php" class="logo"><span>Rent</span></a>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
         ...
         <span class="main-title">User Details</span>  
         <ul class="breadcrumb">
          <li>User Details</li>
       ...
       <button type="button" name="add" id="addEmployee" class="btn btn-success add-btn">Add User</button>&nbsp;&nbsp;&nbsp;
    			...
    			<div class="modal-content">
					...
					<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input type="text" id="username" name="username" required="required" class="form-control " Placeholder="User Name">
											</div>		
