...
if(isset($_POST['add'])) {
    ...
    $old_reading=$_POST['last_meter_reading'];
    $current_reading=$_POST['current_reading'];
    $consumer_name=$_POST['owner_name'];
    $meter_no=$_POST['meter_no'];
    $date=$_POST['date'];
    $total_reading=$_POST['total_reading'];
    $amount=$_POST['amount'];
    $b_id=$_POST['b_id'];
    $flat_light_id=$_POST['b_light_id'];
    $photo = addslashes(file_get_contents($_FILES["photo"]["tmp_name"])); 
    $query=mysqli_query($conn,"INSERT INTO flat_lightbill_payment(building_name,wing,flat_no,consumer_name,meter_no,old_reading,current_reading,date,total_reading,amount,b_id,flat_light_id)
		        VALUES ('$building_name','$wing','$flat_no','$consumer_name','$meter_no','$old_reading','$current_reading','$date','$total_reading','$amount','$b_id','$flat_light_id')");
    if($query==1)
    {
        if(!empty($photo))  
        {
            $last_id = $conn->insert_id;
            mysqli_query($conn,"update flat_lightbill_payment set photo = '$photo' where id='$last_id'");
      
        }
        
          mysqli_query($conn,"update rent_update_details set last_meter_reading = '$current_reading' where b_id='$b_id' and flat_no='$flat_no' and wing='$wing'");
...
<body>
  ...
  <a href="home.php" class="logo"><span>Rent</span></a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li>
              ...
              <i class="fa fa-user-circle-o"></i><span>Add User</span>
              <span class="label label-theme pull-right mail-info"></span>
              </a>
          </li>
        </ul>
    ...
    <section id="main-content">
      ...
      <h3>Flat Lightbill</h3>  
     
        <div class="row">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4 class="d-none light-green">Flat Lightbill</h4>
...
$sql = "select * from flat_details where meter_no <> ' ' and meter_no NOT LIKE '0%' order by building_name asc";
...
?>
 ...
 $(document).ready(function(){
    ...
    $(document).on('click', '#getUser2', function(e){
     ...
     $.ajax({
          url: 'pay_view_flat_lightbill.php',
          type: 'POST',
          data: 'id='+uid,
          dataType: 'html'
     })
