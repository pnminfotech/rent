					...
					<div class="col-lg-6 col-md-6 col-sm-6">
						<h3><?php echo $building_name;?> - <?php echo $wing;?> Wing </h3>
					    	...
					    	<a href="view-tenant-flat-wing.php?building_name=<?php echo $building_name;?>&b_id=<?php echo $id;?>"><button
								...
								<i class="fa fa-mail-reply-all"></i> Back </button></a></div>
					</div>
				</div>
				<div class="row mt">
          		<div class="col-lg-12">
...
$id=$_REQUEST['b_id'];
$wing=$_REQUEST['wing'];
$sql1 = "select floor from rent_update_details where building_name='$building_name' and b_id=$id and wing='$wing' and floor is not null  group by floor";
...
?>
 					 ...
 					 <label class="floor_name" ><?php echo "Floor No : ". $row1["floor"];  ?></label>
                        ...
                        $id=$_REQUEST['b_id'];
                        $wing=$_REQUEST['wing'];
                        $sql = "select * from rent_update_details where building_name='$building_name' and b_id=$id and wing='$wing' and floor='$i'";
                        ...
                        ?>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
									<a href='view-tenant-flat-main-info.php?flat_no=<?php echo $row["flat_no"];?>&flat_name=<?php echo $row["flat_name"];?>&building_name=<?php echo $row["building_name"]; ?>&b_id=<?php echo $row["b_id"]; ?>&wing=<?php echo $row["wing"]; ?>'> 
									<button type="button" class="high btn btn-sm btn-success new-width btn-building">
										
									<span class="material-icons  building-icon <?php echo $row["status"]; ?>"><?php if($room == $Residential){ ?>	night_shelter  <?php } ?> 
									...
									<br> <span class="font-weight-bold f-16"><?php echo $row["flat_name"]; ?></span><br>
									<span><?php echo $row["room_type"]; ?> </span></a><br>
                                	<div class="username"><span ><?php echo $row["user_name"]; ?> </span></div></a>
								</div>
								<?php }
