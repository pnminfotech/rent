        ...
        <!-- /row -->
          ...
          <div class="col-md-12 col-sm-12 tile_count" style="padding: 0px;">
            ...
            <div class="theme-bg center mar-top ">
             <a href="view-tenant-building.php"> <span class="count_top"> Total Building</span>
              <div class="count  "> <?php   
                  $d=date("Y-m-d");
            ...
            <div class="col-md-2 col-sm-4 mt">
            <div class="theme-bg center mar-top ">
              <a href="view-building-flat-room.php">   <span class="count_top" > Total Flat/Room</span>
              <div class="count "> <?php   
              ...
              <div class="count"> <?php   
                ...
                ?>
                   ...
                   <div class="col-md-2 col-sm-4 mt">
                 <div class="theme-bg center mar-top">
                 <a class="mar-top" href="view-pay-rent-status.php">  <span class="count_top" >Pending Status</span>
              <div class="count"> <?php   
