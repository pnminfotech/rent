...
?>
     ...
     <tr>
                        ...
                        <td data-title="Date"><?php echo $row["due_date"];  ?></td>
  					    <td data-title="Month"><?php echo $row["total_month"];  ?></td>
 ...
 $(document).ready(function(){
  ...
  <script type="text/javascript" src="lib/adv-export/jquery.dataTables.min1.js"></script>
