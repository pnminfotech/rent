...
?>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
									...
									<button type="button" class="high btn btn-sm btn-success new-width btn-building">
											...
											<span
												class="material-icons building-icon _bg <?php echo $diff11; if(!empty($create_date)){
												                                                                if($diff == 1){
									...
									<br> <span class="font-weight-bold f-16"><?php echo $diff11; echo $row["flat_no"]; ?><br><?php echo $before_date;?><br><?php echo $main_date1;?></span><br>
    ...
    <footer class="site-footer">
      ...
      <?php include 'footer-notify.php';?>
        ...
        <?php 	/*		<span class="material-icons building-icon _bg <?php echo $diff; if(!empty($create_date)){if(strtotime($before_date) <= strtotime($today_date) && strtotime($main_date1) > strtotime($today_date)){echo " before_date";}else{echo " current_month";}} ?> ">house</span>
        */?>
        <div class="credits">
          <!--
