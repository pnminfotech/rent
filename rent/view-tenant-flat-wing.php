...
<body>
  ...
  <a href="home.php" class="logo"><span>Rent</span></a>
   ...
   <div class="main-title-div">
         <span class="main-title">Wing Details</span>  
         <ul class="breadcrumb">
          <li>Tenant</li>
          <li>Building</li>
           <li>Wing</li>
...
?>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
									...
									<span><?php echo $row["building_name"]; ?> </span></a><br>
                                <span>Flat On rent : 
                               <?php   
                                          $wing=$row["wing"];
                					$result=mysqli_query($conn,"select count(*) as total from flat_details where building_name='$building_name' and b_id=$id and status='Occupied' and wing= '$wing' ");
              						  $data=mysqli_fetch_assoc($result);
              						  echo $data['total'];

              							  ?>
             					
                                </span> <br><span> Empty Flat : <?php   
                                          $wing=$row["wing"];
                					$result=mysqli_query($conn,"select count(*) as total from flat_details where building_name='$building_name' and b_id=$id and status='Empty' and wing= '$wing' ");
              						  $data=mysqli_fetch_assoc($result);
              						  echo $data['total'];
